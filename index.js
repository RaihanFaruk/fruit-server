...
const uri = `mongodb://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0-shard-00-00.v4zzy.mongodb.net:27017,cluster0-shard-00-01.v4zzy.mongodb.net:27017,cluster0-shard-00-02.v4zzy.mongodb.net:27017/myFirstDatabase?ssl=true&replicaSet=atlas-12f5w3-shard-0&authSource=admin&retryWrites=true&w=majority`;
